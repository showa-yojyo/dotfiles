...
# c.InteractiveShell.banner1 = 'Python 3.5.2 |Continuum Analytics, Inc.| (default, Jul  5 2016, 11:41:13) [MSC v.1900 64 bit (AMD64)]\nType "copyright", "credits" or "license" for more information.\n\nIPython 5.1.0 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
...
# The name of a Pygments style to use for syntax highlighting:  tango, colorful,
# algol_nu, manni, paraiso-light, paraiso-dark, emacs, algol, lovelace, trac,
# native, borland, vs, pastie, friendly, vim, igor, perldoc, autumn, murphy,
# fruity, bw, monokai, xcode, default, rrt
