...
# In TeXworks, ptex2pdf -l -ot -kanji=utf8 $syntexoption $fullname.
...
# 
# c.ExtractOutputPreprocessor.extract_output_types = {'image/jpeg', 'image/svg+xml', 'application/pdf', 'image/png'}
